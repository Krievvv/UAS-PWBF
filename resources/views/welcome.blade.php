            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    <div class="mb-3 pb-2">
                        ...
                        <h1 class="display-5">Platform Edukasi Pertanian Masyarakat Indonesia</h1>
                    </div>
                    <p class="mb-4">GrowFarm adalah platform edukasi pertanian yang bertujuan untuk memberdayakan petani, pelajar,
                        dan masyarakat umum dengan pengetahuan praktis dan teknologi modern di dunia pertanian. Kami
                        percaya bahwa pendidikan adalah kunci untuk meningkatkan produktivitas dan keberlanjutan sektor pertanian.
                    </p>
                    <div class="row gx-5 gy-4">
                        <div class="col-sm-6">
                            <i class="fa fa-seedling display-1 text-secondary"></i>
                            <h4>Misi</h4>
                            <p class="mb-0">Melalui konten yang informatif, tutorial interaktif, dan pelatihan berbasis komunitas, 
                                GrowFarm hadir sebagai mitra belajar bagi siapa saja yang ingin mengembangkan keterampilan dan wawasan di bidang pertanian.</p>
                        </div>
                        <div class="col-sm-6">
                            <i class="fa fa-award display-1 text-secondary"></i>
                            <h4>Visi</h4>
                            <p class="mb-0">Dengan pendekatan yang mudah dipahami dan relevan, kami berkomitmen untuk membangun
                                 masa depan pertanian yang lebih maju, inovatif, dan ramah lingkungan.</p>
                        </div>
                    </div>
                </div>
            </div>
