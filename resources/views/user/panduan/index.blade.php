...
<body>
    ...
    <!-- Blog Start -->
    <div class="container py-5">
        <a  class="btn btn-primary my-3">All Panduan</a>
        <div class="row">
            <!-- Blog list Start -->
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <nav aria-label="Page navigation">
                            <ul class="pagination pagination-lg justify-content-center m-0">
                                ...
                                @else
                                    <li class="page-item">
                                        <a class="page-link rounded-0" href="{{ $panduan->previousPageUrl() }}"
                                            aria-label="Previous">
                                            <span aria-hidden="true"><i class="bi bi-arrow-left"></i></span>
                                        </a>
                                    </li>
                                ...
                                {{-- Pagination Elements --}}
                                @foreach ($panduan->links()->elements[0] as $page => $url)
                                    @if ($page == $panduan->currentPage())
                                ...
                                @if ($panduan->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link rounded-0" href="{{ $panduan->nextPageUrl() }}"
                                            aria-label="Next">
