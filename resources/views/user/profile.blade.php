...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="row mb-5">
            <!-- Blog list Start -->
            <div class="col-lg-8">
                <form action="{{ route('profile.update', $user->id) }}" class="row g-3">
                    <div class="col-md-12">
                                ...
                                <div class="col">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><small
                                                class="text-body-secondary">{{ $item->created_at }}</small>
                                        </p>
                                        <a href="{{ route('komunitas.show', $item->komunitas->id) }}"
                                            class="btn btn-sm btn-primary">See</a>
                                        <a href="{{ route('komunitas.leave', Auth::id()) }}"
                                            class="btn btn-sm btn-outline-warning">Leave</a>
                                    </div>
                                </div>
                            </div>
                        </div>
